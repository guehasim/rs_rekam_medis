      ...
      <div class="col-lg-12">
        ...
        <section class="panel">
          <div class="panel-body">            
            ...
            <form class="form-validate form-horizontal" id="register_form_rm_rj" role="form" method="post" action="<?php echo base_url(); ?>rekam/c_rm_rj/proses_update">
              ...
              <div class="form-group">
                <label class="col-lg-2 control-label">No.RM</label>
                  <div class="col-lg-8">
                    <input type="text" name="no_rm" class="form-control" value="<?php echo $u->jln_no_rm;?>" readonly="">
                  </div>
              </div>
              ...
              <div class="form-group">
                  ...
                  <div class="col-lg-4">
                    <select class="form-control" name="status" id="status" >
                      <option value="<?php echo $u->jln_status;?>">
                        <?php
                          $jstatus = $u->jln_status;
                          switch ($jstatus) {
                            case '0':
                              echo "Pasien Lama";
                            break;
                  ...
                  <div class="row">
                    <div class="col-lg-5">
                      <select class="form-control" name="poli" onchange="loadDokter()" id="poli">
                        <option value="<?php echo $u->jln_poli;?>"><?php echo $u->poli_nama;?>.</option>
                    ...
                    <div class="col-lg-5">
                      <select class="form-control" name="dokter" id="dokter">
                        <option value="<?php echo $u->jln_dokter;?>"><?php echo $u->dokter_nama?>.</option>                                                         
                      </select>
                    </div>
                  </div>
                </div>
              ...
              <div class="form-group">
                <label class="col-lg-2 control-label">Diagnosa</label>
                  <div class="col-lg-7">
                    <input type="text" class="form-control" id="indonesia" name="indonesia" value="<?php echo $u->indonesia;?>" readonly="">
                    <input type="hidden" id="categori" name="dig_cat" value="<?php echo $u->jln_categori;?>">
                    <input type="hidden" id="kode_icd" name="dig_kode" value="<?php echo $u->jln_diagnosa;?>">
                  </div>
                  <div class="col-lg-2">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-6">
                  <input class="form-control" id="tgl_masuk" name="tgl_masuk" placeholder="yyyy-MM-dd" value="<?php echo $u->jln_tgl_masuk;?>" data-date-format="yyyy-mm-dd" data-provide="datepicker" />
                </div>
              </div>

              <input type="hidden" name="id" value="<?php echo $u->jln_id;?>">
                  ...
                  <div class="row">
                    <div class="col-lg-5">
                      <select class="form-control" name="biaya" onchange="loadBayar()" id="bayar">
                        <option value="<?php echo $u->jln_biaya;?>"><?php echo $u->bay_nama;?>.</option>
                        <?php
                    ...
                    <div class="col-lg-5">
                      <select name='detail_biaya' id='detbayar' class='form-control'>
                        <option value="<?php echo $u->biaya_detail;?>"><?php echo $u->bay_det_nama;?></option>                            
                      </select>
                    </div>
                  </div>
                </div>
